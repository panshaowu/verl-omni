...
# Disable torchinductor compilation (incompatible with Ascend NPU vector core)
# export TORCHINDUCTOR=0

# Apply verl_omni patches (register Qwen3OmniMoeConfig with AutoModelForCausalLM)
export VERL_USE_EXTERNAL_MODULES=verl_omni.utils.tokenizer_patch
